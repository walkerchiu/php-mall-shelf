...
class CatalogFormRequest extends FormRequest
{
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            $request = Request::instance();
            if (isset($data['product_id']) && $request->isMethod('post')) {
            ...
            if (empty($data['color']) && empty($data['size']) && empty($data['material']) && empty($data['taste']) && empty($data['weight']) && empty($data['length']) && empty($data['width']) && empty($data['height'])){
